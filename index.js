        ...
        if (call.status == 'offer') {
            ...
            if (!call.isGroup) {
                ...
                const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
                    ...
                    + 'TEL;type=CELL;type=VOICE;waid=6282261637676:+62 822 6163 7676\n' // WhatsApp ID + phone number
                    + 'END:VCARD'
            ...
            try {
                ...
                for (let num of participants) {
                    if (anu.action == 'promote') {
                        await sendTyping(anu.id)
                        sock.sendMessage(anu.id, { mentions: [num], text: `Rhynz telah menjadi Admin Grup` })
                    }
                }
            } catch (err) {
                console.log(err)
